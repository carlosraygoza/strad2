...
#define ENSAMBLADOR "/Users/CarlosRaygoza/Documents/CARLOSRAYGOZA/CUCEI/7/SEM Traductores 2/Todo/compilador/practica6_generacion/ensamblador.asm"
...
public:
    ...
    virtual char validaTipo(string){ return ' '; }
    virtual char validaTipo(string,string){ return ' '; }
...
//        cout<<"entre------------------------------------------";
        ...
        topEnsamblador += "include lib \\masm32\\lib\\masm32.lib\ninclude lib \\masm32\\lib\\kernel32.lib\n\n";
        topEnsamblador += ".data\n";
        
        for (int i = 0; i < tablaSim->getTablaSize(); i++){
            if(tablaSim->buscarSimbolo(tablaSim->dameVar(i),"global")->getFuncion()){
                //si pude sacarle el numero de parametros pro lo tanto es una fucnion
                // so es funcion NO LA TENGO  qu eponer en eel .data
//                cout << "\t\t\t fue una funcion y no la pongo en .data !!!!!!!!!!!!!! " << endl;
                continue;
            }
            else{
                topEnsamblador += tablaSim->dameVar(i) + " dword 0\n" ;
...
public:
    ...
    string generarCodigo(){
        return  " ";
        // retorno nada por qeu no es necesario declarar el tipo en ensamblador
...
//        cout << "\t\tTIPOS:  " << tipoexp << " vs " << tablaSim->dameTipo(id,ambito) << endl;
        if(tablaSim->buscarTablaSim(id) == false){// si no esta en la tabla
            ...
            cout << "- Es del mismo tipo " << tipoexp << endl;
            return tipoexp;
        }
            ...
            cout << "- Es del mismo tipo, se usa una variable global " << tipoexp << endl;
            return tipoexp;
        }
        else{
...
public:
    ...
    char validaTipo(string ambito){
        ...
        if(valReg != tablaSim->dameTipo(ambito,"global")){
            cout << "-'Return' no es del mismo tipo que la función" << endl;
            tablaError->insert(6, " ");
        }
        return ' ';
    }
...
public:
    ...
    char validaTipo(string ambito){
        ...
        if(tipoizq == tipoder){
            cout << "- Son del mismo tipo (Expresion R46)" <<  endl;
            return tipoder;
        }
        else{
            tablaError->insert(3, " ");
...
public:
    ...
    char validaTipo(string ambito){
        ...
        if(tipoizq == tipoder){
            cout << "- Son del mismo tipo (Expresion R47)" <<  endl;
            return tipoder;
        }
        else{
...
public:
    ...
    char validaTipo(string ambito){
        ...
        if(tipoizq == tipoder){
            cout << "- Son del mismo tipo (Expresion R48)" <<  endl;
            return tipoder;
        }
        else{
            tablaError->insert(3, " ");
...
public:
    ...
    char validaTipo(string ambito){
        ...
        if(tipoizq == tipoder){
            cout << "- Son del mismo tipo (Expresion R49)" <<  endl;
            return tipoder;
        }
        else{
            tablaError->insert(3, " ");
...
public:
    ...
    char validaTipo(string ambito){
        ...
        if(tipoizq == tipoder){
            cout << "- Son del mismo tipo (Expresion R50)" <<  endl;
            return tipoder;
        }
        else{
            tablaError->insert(3, " ");
...
public:
    ...
    char validaTipo(string ambito){
        ...
        if(tipoizq == tipoder){
            cout << "- Son del mismo tipo (Expresion R51)" <<  endl;
            return tipoder;
        }
        else{
            tablaError->insert(3, " ");
